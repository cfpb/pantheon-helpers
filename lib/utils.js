...
(function() {
  ...
  u.process_resp = function(opts, callback) {
    ...
    is_http_err = function(resp) {
      var ref;
      if (ignore_codes === 'all' || resp.statusCode < 400 || (ref = resp.statusCode, indexOf.call(ignore_codes || [], ref) >= 0)) {
        return false;
      } else {
        return true;
      }
  ...
  u.removeInPlace = function(container, value) {
    var i;
    if (indexOf.call(container, value) >= 0) {
  ...
  u.removeInPlaceById = function(container, record) {
     ...
     */
    var existing_record, i, item, j, len;

...
(function() {
  ...
  v = {
    validate_doc_update: function(validation_fns, get_doc_type, should_ignore_user) {
      return function(new_doc, old_doc, user_ctx, sec_obj) {
        ...
        if (should_ignore_user(user_ctx) || !actions || !new_audit_entries.length) {
          return;
        }
    ...
    get_new_audit_entries: function(new_doc, old_doc) {
      ...
      if (!_.isEqual(old_log, old_entries)) {
        throw {
          forbidden: 'Entries are immutable.'
        };
      }
    ...
    validate_audit_entry: function(actions, entry, actor, old_doc, new_doc) {
      ...
      authorized = actions[entry.a](entry, actor, old_doc, new_doc) || false;
      if (!authorized) {
        throw {

...
(function() {
  var Promise, clone, follow, sortErrorResults, utils, x, _;
  ...
  x.getPluginHandlers = function(plugins, entry, docType) {
    ...
    * docType: document type
     */
    var entryPlugin, filteredHandlers, handler, plugin, pluginHandlers, pluginName, _i, _len, _ref, _ref1, _ref2, _ref3, _ref4;
    filteredHandlers = {};
    for (_i = 0, _len = plugins.length; _i < _len; _i++) {
      plugin = plugins[_i];
      pluginName = plugin.name;
      pluginHandlers = plugin.workers;
      handler = (_ref = pluginHandlers[docType]) != null ? _ref[entry.a] : void 0;
      if (!handler) {
        entryPlugin = entry.plugin || entry.resource;
        if (entryPlugin === pluginName) {
          handler = (_ref1 = pluginHandlers[docType]) != null ? (_ref2 = _ref1.self) != null ? _ref2[entry.a] : void 0 : void 0;
        } else {
          handler = (_ref3 = pluginHandlers[docType]) != null ? (_ref4 = _ref3.other) != null ? _ref4[entry.a] : void 0 : void 0;
        }
      }
      if (handler) {

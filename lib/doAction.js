...
(function() {
  ...
  a.doAction = function(couchUtils, dbName, actionHandlers, validationFns, getDocType, prepDoc, shouldSkipValidationForUser) {
    ...
    doAction = function(actorName, docId, action) {
